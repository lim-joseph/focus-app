		...
		<View>
			...
			<ThemedView style={styles.stepContainer}>
				...
				<View style={styles.streakContainer}>
					<ThemedText type="default">Morning completion %</ThemedText>
					<ThemedText type="default">Morning streak {morningStreak}</ThemedText>
				...
				<View style={styles.streakContainer}>
					<ThemedText type="default">Evening completion %</ThemedText>
					<ThemedText type="default">Evening streak {eveningStreak}</ThemedText>
					<View style={styles.streakBar}>
						<View
